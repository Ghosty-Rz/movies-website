  ...
  const handleClick = (direction: string) => {
    ...
    <div>
        ...
        <div className="group relative md:-ml-2">
            ...
            !isMoved && 'hidden' }`}
            onClick={() => handleClick("left")}/> {/**look up cursor-pointer & hover:scale */}
            
            
            <div ref={rowRef} className="flex scrollbar-hide items-center space-x-0.5  md:space-x-2.5 md:p-2">
                {movies.map((movie) => (
